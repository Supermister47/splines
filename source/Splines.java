...
int chosenLineColor;
int lineColors[] = {color(77,238,234), color(116,238,21), color(255,231,0),
...
public FloatMatrix forwardSubstitutionTridiag(FloatMatrix A, FloatMatrix b) {
  int m = A.rows;
...
public FloatMatrix elimGaussianaTridiag(FloatMatrix A, FloatMatrix b) {
...
public void piecewiseInterpolation() {
  splines.clear();
...
public void setPointColors() {
  for (int i=0; i < lineColors.length; i++) {
    
    
    int red = round(red(lineColors[i]) * 0.5f);
    int green = round(green(lineColors[i]) * 0.5f);
    int blue = round(blue(lineColors[i]) * 0.5f);
...
public void mouseReleased() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Splines" };
    if (passedArgs != null) {
